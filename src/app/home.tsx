...
import { ArrowRight, Code, Smartphone, Brain, Users, CheckCircle, TrendingUp } from 'lucide-react';
...
export default function HomePage() {
  ...
  const features = [
    ...
    {
      icon: Smartphone,
      title: t('features.mobileDev.title'),
      description: t('features.mobileDev.description'),
    },
    {
      icon: Brain,
